...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--allow-install", default="none", choices=list(VALID_INSTALL_POLICIES), help="Dependency install policy; 'ask' returns an install approval request instead of installing")
