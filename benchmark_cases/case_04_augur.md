...
features-by-cells matrix contract
...
```yaml
bio_contract_gold:
  modality: scRNA-seq_or_single_cell_high_dimensional
...
adapter_behavior_gold:
  ...
  reason: R package execution requires dependency installation and review, but demo data sc_sim is small and suitable for reviewed demo
...
evidence_expectations:
  ...
  required_claims_with_evidence:
    ...
    - metadata requires cell_type and label
    - output is AUC table
...
2. Tool may miss label_col/cell_type_col override arguments.
