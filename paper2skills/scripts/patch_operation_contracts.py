...
def action_identity(action: dict[str, Any]) -> tuple[str, str, str, str]:
    return (
...
def build_patch_operation_contracts(
    ...
    for iteration in review_result.get("iterations", []):
        ...
        for action in plan_actions:
            records.append(audit_action(findings, action, iteration_index, "plan", codes))
        for action in applied_actions:
            records.append(audit_action(findings, action, iteration_index, "applied", codes))
